...
for(const route of router.routes) {
  console.log(`Listen`, route.method, `${route.urlPattern.protocol}://${route.urlPattern.username}:${route.urlPattern.password}@${route.urlPattern.hostname}${route.urlPattern.pathname}?${route.urlPattern.search}`.toString())
}
